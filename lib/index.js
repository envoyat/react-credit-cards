...
var ReactCreditCards = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ReactCreditCards, [{
    ...
    value: function setCards() {
      ...
      var customCards = this.props.customCards;
      var newCardArray = [];
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        className: ['rccs__card', "rccs__card--".concat(this.issuer), focused === 'cvc' && this.issuer !== 'amex' && this.issuer !== 'uatp' ? 'rccs__card--flipped' : ''].join(' ').trim()
      }, /*#__PURE__*/_react.default.createElement("div", {
    ...
    get: function get() {
      ...
      if (['amex', 'dinersclub'].indexOf(this.issuer) !== -1) {
        ...
        var _format = [0, 4, 9];
        var _limit = [4, 5, 6];
        nextNumber = "".concat(nextNumber.substr(_format[0], _limit[0]), " ").concat(nextNumber.substr(_format[1], _limit[1]), " ").concat(nextNumber.substr(_format[2], _limit[2]));
      } else if (nextNumber.length > 16) {
        var _format2 = [0, 4, 8, 12];
        var _limit2 = [4, 7];
        nextNumber = "".concat(nextNumber.substr(_format2[0], _limit2[0]), " ").concat(nextNumber.substr(_format2[1], _limit2[0]), " ").concat(nextNumber.substr(_format2[2], _limit2[0]), " ").concat(nextNumber.substr(_format2[3], _limit2[1]));
      } else {
...
_defineProperty(ReactCreditCards, "propTypes", {
  ...
  customCards: _propTypes.default.array,
